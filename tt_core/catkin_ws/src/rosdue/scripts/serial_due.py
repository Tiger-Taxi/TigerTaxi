...
# This will allow launching from a launch file,
# this can cause the due's to crash and the cart to run away, 
# debug was not done use caution if using this segment of code
###########################################################
